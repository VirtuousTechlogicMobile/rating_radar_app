                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: NxNetworkImage(
                                        imageUrl: userSubmitAdController.adsDetailData.value!.imageUrl?[0] ?? '',
                                    ...
                                    Padding(
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: Row(
                                          mainAxisAlignment:
                                              userSubmitAdController.adsDetailData.value!.imageUrl!.length <= 3 ? MainAxisAlignment.start : MainAxisAlignment.spaceBetween,
                                          crossAxisAlignment: CrossAxisAlignment.center,
                                          children: [
                                            if (userSubmitAdController.adsDetailData.value?.imageUrl?.length != null &&
                                                userSubmitAdController.adsDetailData.value!.imageUrl!.length > 4)
                                              InkWell(
                                                onTap: () {
                                                  if (userSubmitAdController.currentImageIndex.value > 1) {
                                                    userSubmitAdController.currentImageIndex.value--;
                                                  }
                                                },
                                                child: Container(
                                            ...
                                            ...List.generate(
                                              userSubmitAdController.adsDetailData.value?.imageUrl?.length ?? 0,
                                              (index) {
                                                if (index >= userSubmitAdController.currentImageIndex.value && index < (userSubmitAdController.currentImageIndex.value + 3)) {
                                                  return Padding(
                                                    padding:
                                                        userSubmitAdController.adsDetailData.value!.imageUrl!.length <= 3 ? EdgeInsets.only(right: Dimens.ten) : EdgeInsets.zero,
                                                    child: ClipRRect(
                                                      borderRadius: BorderRadius.circular(Dimens.twentyTwo),
                                                      child: NxNetworkImage(
                                                        imageUrl: userSubmitAdController.adsDetailData.value?.imageUrl?[index] ?? '',
                                                        height: Dimens.oneHundredNine,
                                                        width: Dimens.oneHundredNineteen,
                                            ...
                                            if (userSubmitAdController.adsDetailData.value?.imageUrl?.length != null &&
                                              ...
                                              InkWell(
                                                onTap: () {
                                                  if (userSubmitAdController.currentImageIndex.value < (userSubmitAdController.adsDetailData.value!.imageUrl!.length - 3)) {
                                                    userSubmitAdController.currentImageIndex.value++;
                                                  }
                                                },
                                                child: Container(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: CommonWidgets.autoSizeText(
                                        ...
                                        textStyle: AppStyles.style29SemiBold.copyWith(color: themeUtils.primaryColorSwitch),
                                        minFontSize: 20,
                                        maxFontSize: 29,
                                      ),
                                    ),
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Text(
                                              'Rs.',
                                              style: AppStyles.style21SemiBold.copyWith(color: themeUtils.whiteBlackSwitchColor.withOpacity(0.50)),
                                            ),
                                          ),
                                          Text(
                                            userSubmitAdController.adsDetailData.value?.adPrice.toString() ?? '',
                                            style: AppStyles.style40SemiBold.copyWith(color: themeUtils.whiteBlackSwitchColor),
                                          ),
                                        ],
                                      ),
                                    ),
                                    Flexible(
                                      child: Padding(
                                        ...
                                        child: Text(
                                          userSubmitAdController.adsDetailData.value?.adContent ?? '',
                                          style: AppStyles.style18Normal.copyWith(color: themeUtils.whiteBlackSwitchColor.withOpacity(0.50)),
                                          maxLines: 11,
                                    ...
                                    Obx(
                                      () => Padding(
                                        ...
                                        child: Text(
                                          ...
                                          style: AppStyles.style14SemiBold600.copyWith(color: themeUtils.primaryColorSwitch),
                                          maxLines: 11,
                                          overflow: TextOverflow.ellipsis,
                                          textAlign: TextAlign.justify,
                                        ),
                        ...
                        Padding(
                          padding: EdgeInsets.only(top: Dimens.thirty, bottom: Dimens.fifteen),
                          child: CommonWidgets.autoSizeText(
                            text: 'submit_task'.tr,
                        ...
                        Obx(
                          () => Visibility(
                            visible: userSubmitAdController.preFilledAdDetailData.value == null,
                            replacement: Wrap(
                              direction: Axis.horizontal,
                              spacing: Dimens.ten,
                              children: List.generate(
                                userSubmitAdController.preFilledAdDetailData.value?.imageList?.length ?? 0,
                                (index) {
                                  return NxNetworkImage(
                                    imageUrl: userSubmitAdController.preFilledAdDetailData.value?.imageList?[index] ?? '',
                                          ...
                                          child: InkWell(
                                            ...
                                            child: Container(
                                              ...
                                              child: Stack(
                                                alignment: Alignment.center,
                                                children: [
                                                  CommonWidgets.fromSvg(svgAsset: SvgAssets.uploadImageIcon, color: themeUtils.primaryColorSwitch),
                                                  CommonWidgets.fromSvg(svgAsset: SvgAssets.uploadImageAddIcon, color: themeUtils.primaryColorSwitch),
                                                ],
                                              ),
                                            ),
                                          ),
                        ...
                        Padding(
                          padding: EdgeInsets.only(top: Dimens.thirty, bottom: Dimens.ten),
                          child: CommonWidgets.autoSizeText(
                            text: 'comments'.tr,
                            textStyle: AppStyles.style18Bold.copyWith(color: themeUtils.whiteBlackSwitchColor),
                            minFontSize: 8,
                          ...
                          children: [
                            Expanded(
                              child: CustomTextField(
                                ...
                                isReadOnly: userSubmitAdController.preFilledAdDetailData.value != null,
                        ...
                        if (userSubmitAdController.preFilledAdDetailData.value == null)
                          Padding(
                            padding: EdgeInsets.only(top: Dimens.oneHundredEightyFive),
                            child: Row(
