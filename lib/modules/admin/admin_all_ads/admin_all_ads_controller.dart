...
class AdminAllAdsController extends GetxController {
  ...
  Future getAdsList({UserAdsListDataModel? adLastDocument}) async {
    ...
    List<UserAdsListDataModel>? getAllAdsList = await DatabaseHelper.instance
        .getAllAdsList(nDataPerPage: 10, adLastDocument: adLastDocument);
  ...
  void onScroll() {
    if (scrollController.position.pixels ==
        ...
        adsList.length != totalAdsCount.value) {
