...
class AdminAllAdsListScreen extends StatefulWidget {
  const AdminAllAdsListScreen({super.key});

  @override
  State<AdminAllAdsListScreen> createState() => _AdminAllAdsListScreenState();
}

class _AdminAllAdsListScreenState extends State<AdminAllAdsListScreen> {
...
Widget screenMainLayout(
    {required ThemeColorsUtil themeUtils,
    required UserAllAdsController userAllAdsController}) {
  return Expanded(
          ...
          child: Material(
            ...
            child: Padding(
              padding: EdgeInsets.symmetric(
                  horizontal: Dimens.thirty, vertical: Dimens.forty),
                                  ...
                                  (index) {
                                    return UserAdViewComponent(
                                      ...
                                      userAdsListDataModel:
                                          UserAdsListDataModel(
                                        adName: userAllAdsController
                                            .adsList[index].adName,
                                        adContent: userAllAdsController
                                            .adsList[index].adContent,
                                        byCompany: userAllAdsController
                                            .adsList[index].byCompany,
                                        imageUrl: userAllAdsController
                                            .adsList[index].imageUrl,
                                        adPrice: 200,
                                      ),
                                      onViewButtonTap: () {
                                        RouteManagement
                                            .goToUserSubmitAdScreenView(
                                                adDocumentId:
                                                    userAllAdsController
                                                            .adsList[index]
                                                            .docId ??
                                                        '');
                                      },
