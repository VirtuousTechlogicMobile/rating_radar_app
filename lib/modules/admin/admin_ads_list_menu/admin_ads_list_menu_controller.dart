...
class AdminAdsListMenuController extends GetxController {
  ...
  RxList<UserAdsListDataModel> adminCreatedAdsList =
      <UserAdsListDataModel>[].obs;
  ...
  Future getAdsData({required int sortBy, String? searchTerm}) async {
    ...
    List<UserAdsListDataModel>? submittedAdData =
        await DatabaseHelper.instance.getsAdminTotalAdsList(
      nDataPerPage: 9,
