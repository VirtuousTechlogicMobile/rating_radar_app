          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(
                      top: Dimens.eighteen, bottom: Dimens.eleven),
                  child: Divider(
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius:
                              BorderRadius.circular(Dimens.oneHundredFifteen),
                        ),
                        child: Text(
                          'view'.tr,
                          style: AppStyles.style13semiBold.copyWith(
                              color: themeColorUtil.blackWhiteSwitchColor),
                        ),
                      ),
                    ),
                    Flexible(
                      child: Column(
                        ...
                        children: [
                          CommonWidgets.autoSizeText(
                            text: 'task_price'.tr,
                            textStyle: AppStyles.style9SemiBold.copyWith(
                                color: themeColorUtil.whiteBlackSwitchColor),
                            minFontSize: 9,
                            maxFontSize: 9,
                          ),
