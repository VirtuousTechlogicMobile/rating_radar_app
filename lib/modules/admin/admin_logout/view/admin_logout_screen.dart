...
class AdminLogoutScreen extends StatelessWidget {
  final adminLogoutController = Get.find<AdminLogoutController>();

  AdminLogoutScreen({super.key}) {
    adminLogoutController.logoutAdmin();
  }
              ...
              children: [
                ...
                Padding(
                  ...
                  child: CustomButton(
                    ...
                    onTap: () async {
                      RouteManagement.goToAdminSignInView();
                    },
                  ),
                ),
              ],
