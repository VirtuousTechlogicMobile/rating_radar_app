...
import 'package:RatingRadar_app/modules/user/user_ads_list_menu/model/user_submitted_ads_list_data_model.dart';
...
class UserAdsListMenuController extends GetxController {
  ...
  RxList<UserSubmittedAdsListDataModel> userSubmittedAdsList =
      <UserSubmittedAdsListDataModel>[].obs;

  Future getAdsData() async {
    Get.context?.loaderOverlay.show();
    List<UserSubmittedAdsListDataModel>? submittedAdData =
        await DatabaseHelper.instance.getsUserSubmittedAdsList(nDataPerPage: 9);
